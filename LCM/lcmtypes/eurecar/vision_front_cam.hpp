...
#ifndef __eurecar_vision_front_cam_hpp__
#define __eurecar_vision_front_cam_hpp__


namespace eurecar
{

class vision_front_cam
{
    public:
        int64_t    timestamp;
...
int vision_front_cam::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int vision_front_cam::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int vision_front_cam::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t vision_front_cam::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* vision_front_cam::getTypeName()
{
    return "vision_front_cam";
}

int vision_front_cam::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int vision_front_cam::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int vision_front_cam::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
int64_t vision_front_cam::_computeHash(const __lcm_hash_ptr *)
{
    int64_t hash = 0x133c99cd7f4a0fddLL;
