@echo on
copy ..\lcm-1.2.1\WinSpecific\x64\Release\lcm-gen.exe       lcmdefs
copy ..\lcm-1.2.1\WinSpecific\x64\Release\libglib-2.0-0.dll lcmdefs
copy ..\lcm-1.2.1\WinSpecific\x64\Release\libintl-8.dll     lcmdefs
