...
#ifndef __eurecar_rmc_t_hpp__
#define __eurecar_rmc_t_hpp__
...
/**
 * Eurecar GPS raw data(velocity & heading)
 *
 */
class rmc_t
{
...
int rmc_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int rmc_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int rmc_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t rmc_t::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* rmc_t::getTypeName()
{
    return "rmc_t";
}

int rmc_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int rmc_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int rmc_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
int64_t rmc_t::_computeHash(const __lcm_hash_ptr *)
{
    int64_t hash = 0x22452ab9ee8a6ddbLL;
